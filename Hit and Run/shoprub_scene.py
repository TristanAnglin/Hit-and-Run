...
class ShopRubScene(Scene):
    ...
    def update(self):
        ...
        self.price1_label.text = str(globals.rubprice1) + '\n{' + str(globals.rublv1) + '}'
        self.price2_label.text = str(globals.rubprice2) + '\n{' + str(globals.rublv2) + '}'
    ...
    def touch_ended(self, touch):
        ...
        if self.buy1_label.frame.contains_point(touch.location):
            ...
            if globals.rubies >= globals.rubprice1:
                ...
                globals.playercritchance = int(round(globals.playercritchance*1.5))
        ...
        if self.buy2_label.frame.contains_point(touch.location):
            ...
            if globals.rubies >= globals.rubprice2:
                ...
                globals.playercritdmg = int(round(globals.playercritdmg*1.05))
                sound.play_effect('assets/Ding_1.caf')
            else:
                pass
